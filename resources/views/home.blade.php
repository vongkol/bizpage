...
@section ('content')
      ...
      <div class="container">
        ...
        @foreach($about_us as $a)
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="{{asset('img/'.$a->photo)}}" alt="" class="img-fluid">
                <div class="icon"><i class="{{$a->icon}}"></i></div>
              </div>
              <h2 class="title"><a href="#">{{$a->title}}</a></h2>
              <p>
                {{$a->description}}
              </p>
            </div>
    ...
    <section id="call-to-action" class="wow fadeIn">
      <div class="container text-center">
        ...
        <a class="cta-btn" href="#">Submit Request</a>
      </div>
    </section>
    ...
    <section id="facts"  class="wow fadeIn">
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up">{{$fact->hour}}</span>
        ...
        <div class="facts-img">
          <img src="{{asset('img/'.$fact->photo)}}" alt="" class="img-fluid">
        </div>
