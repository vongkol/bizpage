...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('adminbower_components/Ionicons/css/ionicons.min.css')}}">
  <!-- jvectormap -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('admin')}}" class="logo">
      ...
      <span class="logo-mini"><b>D</b>DF</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">KARABINE PAGE</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{url('myadmin/user/logout')}}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" id='menu'> 
        ...
        <li id='menu_home'>
          ...
          <li id='menu_slide'>
          <a href="{{url('myadmin/slide')}}">
            <i class="fa fa-star"></i> <span>Slide Show</span>
            <span class="pull-right-container">
              <i class="fa fa- pull-right"></i>
            </span>
          </a>
